...
///
/// Run `UPDATE_CLI_DOCS=1 cargo test` to regenerate the doc after changing any
...
mod cli_docs {
    ...
    fn generate() -> String {
        ...
        out.push_str("<!-- Do not edit by hand. Run `UPDATE_CLI_DOCS=1 cargo test` to regenerate. -->\n\n");
    ...
    fn cli_docs_up_to_date() {
        ...
        assert_eq!(existing, generated, "{DOC_PATH} is out of date. Regenerate with:\n\n    UPDATE_CLI_DOCS=1 cargo test\n");
    }
}
