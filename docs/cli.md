...
<!-- Generated by the `cli_docs` test from `tasync --help`. -->
<!-- Do not edit by hand. Run `UPDATE_DOCS=1 cargo test` to regenerate. -->

## tasync

```
Usage: tasync <COMMAND>
...
Usage: tasync info [OPTIONS] --root <ROOT> --input <INPUT>
...
Usage: tasync db [OPTIONS] --input <INPUT>
...
Usage: tasync sync [OPTIONS] --input <INPUT>
